...
Revision ID: 82d531d559f2
Revises: 
Create Date: 2026-04-01 15:30:01.643210
...
def upgrade() -> None:
    ...
    sa.Column('level', sa.Enum('A1', 'A2', 'B1', 'B2', 'C1', 'C2', 'Business', name='courselevel'), nullable=True),
    ...
    sa.Column('regime', sa.Enum('remote', 'in_person', 'hybrid', name='courseregime'), nullable=True),
    sa.Column('location', sa.String(), nullable=True),
    sa.Column('teacher_id', sa.BigInteger(), nullable=True),
    sa.Column('status', sa.Enum('draft', 'active', 'full', 'completed', name='coursestatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    op.create_index(op.f('ix_fun_facts_slug'), 'fun_facts', ['slug'], unique=True)
    op.create_table('hour_transfers',
    sa.Column('id', sa.BigInteger(), nullable=False),
    ...
    sa.Column('type', sa.Enum('package', 'extra_hour', 'trial', name='paymenttype'), nullable=True),
    ...
    sa.Column('user_id', sa.BigInteger(), nullable=True),
    sa.Column('course_id', sa.BigInteger(), nullable=True),
    sa.Column('status', sa.Enum('active', 'completed', 'transferred', 'canceled', name='enrollmentstatus'), nullable=True),
    ...
    op.create_table('pre_enrollments',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('user_id', sa.BigInteger(), nullable=True),
    sa.Column('course_id', sa.BigInteger(), nullable=True),
    sa.Column('status', sa.Enum('pending', 'converted', 'cancelled', name='preenrollmentstatus'), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('status', sa.Enum('waiting', 'offered', 'accepted', 'expired', name='waitliststatus'), nullable=True),
    ...
    sa.Column('status', sa.Enum('scheduled', 'completed', 'cancelled', 'no_show', name='bookingstatus'), nullable=True),
